...
import os
import sys
from Sentence_Polarity.datasets.emoticons_patch import patch_emoticons
...
class Lexicon:
    ...
    def __init__(self):
        self.filename =  "/Users/clairemalbrel/code/clairemalbrel/STOCK_PREDICT/STOCK_PREDICT/Sentence_Polarity/stored/lexicon"
        try:
    ...
    def load(self):
        ...
        """
        dictionary_file = open("/Users/clairemalbrel/code/clairemalbrel/STOCK_PREDICT/STOCK_PREDICT/Sentence_Polarity/datasets/subjclueslen1-HLTEMNLP05.tff","r")
